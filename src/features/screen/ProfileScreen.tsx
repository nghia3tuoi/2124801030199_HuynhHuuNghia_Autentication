      ...
      >
        ...
        >
          ...
          >
            <Image
              ...
              source={{
                uri: "https://tse4.mm.bing.net/th?id=OIP.vCjk_RJSFpFrw9vdrOvdOwHaE8&pid=Api&P=0&h=220",
              }}
            />
          </View>
          <Text
        ...
        <View style={{ padding: 10}}>
          ...
          <View style={{ padding: 5, gap: 15 }}>
            ...
            <TouchableOpacity style={{backgroundColor:Colors.primary, alignItems:'center', justifyContent:'center',  height:35, borderRadius:5}}>
              <Text style={{fontSize:18, color:Colors.text, fontWeight:'600'}}>Chỉnh sửa trang cá nhân</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={{padding:10, marginBottom:20}}>
            <View style={{width:'100%', height:400}}>
              <Image style={{width:'100%', height:'100%', borderRadius:10, objectFit:'cover'}} source={{uri:'https://tse3.mm.bing.net/th?id=OIP.m72F76kNE7iOESxTqQ_2rgHaE8&pid=Api&P=0&h=220'}}/>
            </View>
          </View>
      </ImageBackground>
    </ScrollView>
